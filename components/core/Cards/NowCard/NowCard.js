      ...
      <div className={styles.wrapper}>
        <div className={styles.leftPortion}>
          ...
          <div className={styles.songInfo}>
            ...
            <hr />
            <h2 className={styles.artistAndAlbum}>Gracie Abrams &bull; The Secret of Us</h2>
            <p className={styles.mySpotify}>Well, you can checkout my playlist on <a href="/">Spotify</a></p>
            <MainButton
                href={"/"}
